...
class RavnicaCardConverter:
    ...
    def _convert_single_card(self, card: Dict[str, Any]) -> Dict[str, Any] | None:
        ...
        # Apply keyword traits to Traits field
        self._apply_keyword_traits(creature, keywords)
        
        # Apply color traits
        self._apply_color_traits(creature, card)
        
        # Apply trait adjustments to stats
